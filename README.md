...
<html lang="en">
    <head>
        ...
        <style>
            .container { border: 2px solid #ff8000; padding: 20px; max-width: 1500px; max-height: 1500px; margin: auto; }
            .container2 { border: 2px solid #ff8000; padding: 20px; height: 50px; width: 250px; margin: auto; }
            ...
            .imageContainer {border: 2px solid #ff8000; padding: 20px 20px 20px 20px; margin-right: 150px; max-height: 300px; max-width: 300px; display: inline-block; position: relative; display: none;}
